    ...
    <v-form v-if="!isLoading" ref="form" v-model="valid" lazy-validation>
      <div class="inner">
        <span style="font-size: 200%">{{
          $t('studentProfile.testOnlineClasses')
        }}</span
        ><br />
...
header {
  position: relative;
  background: url(https://cdn.discordapp.com/attachments/914528007132180521/930445891385561129/3132663.png)
    center no-repeat;
